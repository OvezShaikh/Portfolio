...
import cv from "../assets/Ovez-Ats-Resume.pdf";
import { MdDownload } from "react-icons/md";
import me from "../assets/imag01.jpeg";
        ...
        <div className="flex sm:justify-between sm:flex-row xl:flex-row flex-col-reverse gap-10 items-center">
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-[#915EFF]`}>
              ...
              <p>
                A passionate 🎯️ Front-End React Developer and Cloud Engineer based in Maharashtra,
